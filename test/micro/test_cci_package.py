...
class TestCciPackage:
    """
        Test that finding a conanfile in a CCI file structure works as expected.
    """
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("lz4", None, "1.10.0", "recipes/lz4/all/conanfile.py", None),  # the latest version of lz4
    ...
    def test_find_name_and_version(
            self,
            package_name: str,
